...
import com.bonsai.bloom.adapters.EstadisticasUsuarioAdapter;
...
public class FragmentEstadisticasUsuarioBloom extends Fragment {

	//private String URLJSON = "http://bonsai.com.ec/quizzes/TESIS/Estadisticas/timer.php?opcion=consultatimerpersonal";
	private String URLJSON = "http://softwarefactoryuees.com.ec/BloomWEB/Estadisticas/timer.php?opcion=consultatimerpersonal";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		jsonTask = new GetJSON(URLJSON + "&idgrupoper=" + idgrupo + "&idusuariopersonal=" + getArguments().getString("EXTRA1"));
		jsonTask.execute();
		return v;
	}
	...
	public class GetJSON extends AsyncTask<Void, Void, JSONArray> {
		...
		protected void onPostExecute(JSONArray response) {
			if (isAdded()) {
                ...
                if (!success) {
					Snackbar.make(mContentView, R.string.error_descarga, Snackbar.LENGTH_LONG).setAction("Action", null).show();
					getActivity().onBackPressed();
                } else {
                    try {
                        EstadisticasUsuarioAdapter adapter = new EstadisticasUsuarioAdapter(getActivity(), response);
                        ...
                        textCabecera.setText(R.string.texview_cabecera_estadisticas);
