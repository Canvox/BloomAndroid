...
import com.bonsai.bloom.adapters.HistorialTemasAdapter;
...
public class FragmentHistorialTemasBloom extends Fragment {

	//private String URLJSON = "http://bonsai.com.ec/quizzes/TESIS/Estadisticas/historialquizz.php?opcion=consultahistorialtema";
	private String URLJSON = "http://softwarefactoryuees.com.ec/BloomWEB/Estadisticas/historialquizz.php?opcion=consultahistorialtema";
	...
	public class GetJSON extends AsyncTask<Void, Void, JSONArray> {
		...
		protected void onPostExecute(JSONArray response) {
			if (isAdded()) {
                ...
                if (success) {
                    try {
						HistorialTemasAdapter adapter = new HistorialTemasAdapter(getActivity(), response);
                        ...
                        textCabecera.setText(R.string.texview_cabecera_historial_temas);
